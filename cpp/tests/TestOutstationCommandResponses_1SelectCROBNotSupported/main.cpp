...
qDebug()<<"********SUITE('1SelectCROBNotSupported')********";
...
//    std::string name("C0 03 0C 01 17 01 03 01 01 01 00 00 00 01 00 00 00 00");       
    uint8_t name[] = {18, 0xC0, 0x03, 0x0C, 0x01, 0x17, 0x01, 0x03, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00};
