...
*                                *ParseResult_uint8_t result =0
    ...
    CheckForTaskStart_in_OContext1
        ...
        CheckForUnsolicited_in_OContext1
REQUIRE(t.lower->PopWriteAsHex() == 'C0 81 80 04 0C 01 17 01 03 01 01 01 00 00 00 01 00 00 00 04')
temp=                                C0 81 80 04 0C 01 17 01 03 01 01 01 00 00 00 01 00 00 00 04
