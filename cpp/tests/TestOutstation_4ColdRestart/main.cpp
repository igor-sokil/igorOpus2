...
////    t.application->coldRestartSupport = RestartMode::SUPPORTED_DELAY_FINE;
  t.application.coldRestartSupport = RestartMode_SUPPORTED_DELAY_FINE;
////    t.application->coldRestartTimeDelay = 1;
  t.application.coldRestartTimeDelay = 1;

////    t.SendToOutstation("C1 0D");
//    std::string name1("C1 0D");       
    uint8_t name1[] = {2, 0xC1, 0x0D};
...
qDebug()<<"REQUIRE(t.lower->PopWriteAsHex() == 'C1 81 80 00 34 02 07 01 01 00')";
