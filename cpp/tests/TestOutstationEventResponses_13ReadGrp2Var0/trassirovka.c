...
*                                                    *GroupVariation_uint16_t enumeration= 200
...
*                                            *record->gGroupVariationRecord.group=2
*                                            *record->gGroupVariationRecord.variation=0
*                                            *record->gGroupVariationRecord.enumeration=200
*                                            *IAPDUHandler* pHandler=0
...
*                                                *GroupVariation_uint16_t gv= 200
*                                                *GroupVariation_Group2Var0

                                                SelectByType_in_EventStorage1
*                                                *EventType_uint16_t type= 0
@@@@                                                EventType_Binary
...
*                                                                    *id.variation= 1
*                                                                    *qc= 40
@@@@                                                                    *write_to_in_UInt8_static = 6421366->2
@@@@                                                                    *write_to_in_UInt8_static = 6421367->1
@@@@                                                                    *write_to_in_UInt8_static = 6421368->40
...
*                                                                            *DNPTime timeDNPTime.value= 6411860
*                                                                            *DNPTime timeDNPTime.quality= 200
@@@@                                                                            *write_to_in_UInt16_static = 6421371->0
...
+                CheckForUnsolicited_in_OContext1
request= C0 01 02 00 06
response= E0 81 80 00 02 01 28 01 00 00 00 01
temp=     E0 81 80 00 02 01 28 01 00 00 00 01
