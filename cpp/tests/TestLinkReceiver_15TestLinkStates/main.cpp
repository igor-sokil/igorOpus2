...
////    auto frame = LinkFrame::FormatTestLinkStatus(writeTo, false, true, 1, 2, nullptr);
RSeq_for_Uint16_t frame = FormatTestLinkStatus_in_LinkFrame_static(
...
boolean tmp = CheckLastWithDFC_in_MockFrameSink(&(t.sink),
    LinkFunction_PRI_TEST_LINK_STATES, false, true, 1, 2);
qDebug()<<"REQUIRE(t.sink.CheckLastWithDFC(LinkFunction::PRI_TEST_LINK_STATES, false, true, 1, 2))";
qDebug()<<"tmp= "<<tmp;
