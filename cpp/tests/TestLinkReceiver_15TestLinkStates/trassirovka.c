...
@@@@        *write_to 6421457->114

            {AddCrc_in_CRC_static1
*            *uint16_t length =8
@@@@            *write_in_UInt16_static = 6421462->30403
...
REQUIRE(t.sink.CheckLastWithDFC(LinkFunction::PRI_TEST_LINK_STATES, false, true, 1, 2))
tmp=  1
