...
*    *boolean value= 0
*    *Flags flags.value= 1
*    *DNPTime timeDNPTime.value= 50595078
...
*    *boolean value= 0
*    *Flags flags.value= 2
*    *DNPTime timeDNPTime.value= 6411112
*    *DNPTime timeDNPTime.quality= 1
...
*                                                *pList_for_EventRecord->head= 6412464

                                                    From__in__Iterator_in_List_for_EventRecord_static1
*                                                    *Node_for_EventRecord* start= 6412464
...
*                                                        *GroupVariation_uint16_t enumeration= 2007
...
*                                                *record->gGroupVariationRecord.group=32
*                                                *record->gGroupVariationRecord.variation=7
*                                                *record->gGroupVariationRecord.enumeration=2007
*                                                *IAPDUHandler* pHandler=0
...
*                                                    *GroupVariation_uint16_t gv= 2007
*                                                    *GroupVariation_Group32Var7

                                                    SelectByType_AnalogSpec_in_EventBuffer1
*                                                    *EventAnalogVariation_uint8_t type= 6

                                                    SelectByType_for_AnalogSpec_in_EventSelection_staticOver2_1
*                                                    *event_variation_t_in_AnalogInfo variation= 6

                                                        SelectByTypeGeneric_for_AnalogSpec_in_EventSelection_static1
*                                                        *boolean useDefaultVariation= 0
*                                                        *event_variation_t_in_AnalogInfo variation= 6

                                                            select__for__TypedEventRecord_for_AnalogSpec_in_EventSelection1
*                                                            *uint32_t num_selected= 0
*                                                            *uint32_t maxEv= 65535
*                                                            *boolean useDefaultVariation= 0
*                                                            *event_variation_t_in_AnalogInfo variation= 6
*                                                            *node->record->value.state= 0
*                                                            *EventState_unselected= 0
                                                            select__for__TypedEventRecord_for_AnalogSpec_in_EventSelection2
*                                                            *node->defaultVariation= 0
                                                            select__for__TypedEventRecord_for_AnalogSpec_in_EventSelection3
...
*                                                                *id.variation= 7
*                                                                *qc= 40
@@@@                                                                *write_to_in_UInt8_static = 6421334->32
@@@@                                                                *write_to_in_UInt8_static = 6421335->7
@@@@                                                                *write_to_in_UInt8_static = 6421336->40
...
+                CheckForUnsolicited_in_OContext1
request= C0 01 20 07 06
response= E0 81 80 00 20 07 28 01 00 00 00 01 00 00 00 00 06 05 04 03 02 01
temp= E0 81 80 00 20 07 28 01 00 00 00 01 00 00 00 00 06 05 04 03 02 01
...
*            *PointClass_Class3= 8
            ...
            Update_AnalogSpec_in_EventUpdate_static1
            Update_AnalogSpec_in_EventUpdate_static2
*            *(typed_node->value).selectedVariation= 6
...
*                                                                *uint8_t variation= 0
*                                                                *GroupVariationType_EVENT
*                                                            *GroupVariation_uint16_t enumeration= 2000
                                                    ParseHeader_in_APDUParser_static3
                                                    ParseHeader_in_APDUParser_static4
...
*                                                    *record->gGroupVariationRecord.enumeration=2000
*                                                    *IAPDUHandler* pHandler=0
                                            Parse_in_APDUParser_static2
...
@@@@                                                    *GroupVariationType_EVENT
                                                        ...
                                                        SelectMaxCount_in_EventBuffer1
*                                                        *uint32_t maximum= 4294967295
*                                                        *GroupVariation_uint16_t gv= 2000
*                                                        *GroupVariation_Group32Var0

                                                        SelectByType_in_EventStorage1
*                                                        *EventType_uint16_t type= 1
@@@@                                                        EventType_Analog

                                                            SelectByType_for_AnalogSpec_in_EventSelection_staticOver1_1

                                                                SelectByTypeGeneric_for_AnalogSpec_in_EventSelection_static1
*                                                                *boolean useDefaultVariation= 1
*                                                                *event_variation_t_in_AnalogInfo variation= 0
