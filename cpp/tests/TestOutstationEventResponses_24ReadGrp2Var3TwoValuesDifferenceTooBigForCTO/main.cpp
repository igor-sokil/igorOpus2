...
void configure_in_24ReadGrp2Var3TwoValuesDifferenceTooBigForCTO(DatabaseConfig*);
void configure_in_24ReadGrp2Var3TwoValuesDifferenceTooBigForCTO(DatabaseConfig* db)
{
}

void update_in_24ReadGrp2Var3TwoValuesDifferenceTooBigForCTO(IUpdateHandler*);
void update_in_24ReadGrp2Var3TwoValuesDifferenceTooBigForCTO(IUpdateHandler* db)
{
    std::cout << "update_in_24ReadGrp2Var3TwoValuesDifferenceTooBigForCTO" <<'\n';
...
////    };
 ...
 DNPTime dDNPTime1;
 DNPTime_in_DNPTimeOver3(&dDNPTime1, 0x000000, TimestampQuality_SYNCHRONIZED);
 DNPTime dDNPTime2;
 DNPTime_in_DNPTimeOver3(&dDNPTime2, 0x010000, TimestampQuality_SYNCHRONIZED);
...
qDebug()<<"********SUITE('24ReadGrp2Var3TwoValuesDifferenceTooBigForCTO')********";
...
////    TestEventRead("C0 01 02 03 06", rsp, update);
 ...
 std::string response("E0 81 80 00 33 01 07 01 00 00 00 00 00 00 02 03 28 01 00 03 00 01 00 00 33 01 07 01 00 00 01 00 00 00 02 03 28 01 00 04 00 81 00 00");       

 std::string request("C0 01 02 03 06");       
 TestEventRead(request, response,
                   ////const std::function<void(IUpdateHandler& db)>& loadFun,
                   update_in_24ReadGrp2Var3TwoValuesDifferenceTooBigForCTO,
                   ////const std::function<void(DatabaseConfig& db)>& configure = [](DatabaseConfig& view) {})
                   configure_in_24ReadGrp2Var3TwoValuesDifferenceTooBigForCTO);
