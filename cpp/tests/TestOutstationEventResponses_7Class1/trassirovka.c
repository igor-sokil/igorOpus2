...
*    *id.variation= 2
*    *qc= 6
@@@@    *write_to_in_UInt8_static = 6421662->60
@@@@    *write_to_in_UInt8_static = 6421663->2
@@@@    *write_to_in_UInt8_static = 6421664->6
...
*                                            *pList_for_EventRecord->head= 6412480

                                                From__in__Iterator_in_List_for_EventRecord_static1
*                                                *Node_for_EventRecord* start= 6412480
...
*                                                                *id.variation= 1
*                                                                *qc= 40
@@@@                                                                *write_to_in_UInt8_static = 6421350->2
@@@@                                                                *write_to_in_UInt8_static = 6421351->1
@@@@                                                                *write_to_in_UInt8_static = 6421352->40
...
*                                                                *boolean value= 0
*                                                                *Flags flags.value= 1
*                                                                *DNPTime timeDNPTime.value= 6411844
*                                                                *DNPTime timeDNPTime.quality= 184
...
*                                                                        *DNPTime timeDNPTime.value= 6411844
*                                                                        *DNPTime timeDNPTime.quality= 184
@@@@                                                                        *write_to_in_UInt16_static = 6421355->0
