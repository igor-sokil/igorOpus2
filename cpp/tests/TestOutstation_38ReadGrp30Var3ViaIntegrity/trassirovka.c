********SUITE('38ReadGrp30Var3ViaIntegrity')********
...
*                                                        *GroupVariation_uint16_t enumeration= 1e03
...
*                                                *record->gGroupVariationRecord.enumeration=1e03
*                                                *IAPDUHandler* pHandler=0
...
*                                        *map.size()= 1
*                                        *StaticAnalogVariation_uint8_t variation= 2

                                            get_for_AnalogSpec_in_StaticWriters_static1
*                                            *StaticAnalogVariation_uint8_t variation= 2
*                                            *StaticAnalogVariation_Group30Var3
...
@@@@                                                *write_in_UInt8_static = 6421367->3
...
@@@@                                        *write_in_UInt32_static = 6421371->0
...
response= C0 81 80 00 1E 03 00 00 00 00 00 00 00
temp=     C0 81 80 00 1E 03 00 00 00 00 00 00 00
