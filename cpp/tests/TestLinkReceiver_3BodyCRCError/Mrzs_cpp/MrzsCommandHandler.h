...
#ifndef OPENDNP3_UNITTESTS_MRZS_COMMAND_HANDLER_H
#define OPENDNP3_UNITTESTS_MRZS_COMMAND_HANDLER_H
...
void DoOperate_ControlRelayOutputBlock_in_MrzsCommandHandler_override(void*, ControlRelayOutputBlock* command, uint16_t index, OperateType_uint8_t opType);
void DoOperate_AnalogOutputInt16_in_MrzsCommandHandler_override(void*, AnalogOutputInt16* command, uint16_t index, OperateType_uint8_t opType);
void DoOperate_AnalogOutputInt32_in_MrzsCommandHandler_override(void*, AnalogOutputInt32* command, uint16_t index, OperateType_uint8_t opType);
void DoOperate_AnalogOutputFloat32_in_MrzsCommandHandler_override(void*, AnalogOutputFloat32* command, uint16_t index, OperateType_uint8_t opType);
void DoOperate_AnalogOutputDouble64_in_MrzsCommandHandler_override(void*, AnalogOutputDouble64* command, uint16_t index, OperateType_uint8_t opType);

void DoOperate_ControlRelayOutputBlock_in_MrzsCommandHandler(MrzsCommandHandler*, ControlRelayOutputBlock* command, uint16_t index, OperateType_uint8_t opType);
void DoOperate_AnalogOutputInt16_in_MrzsCommandHandler(MrzsCommandHandler*, AnalogOutputInt16* command, uint16_t index, OperateType_uint8_t opType);
void DoOperate_AnalogOutputInt32_in_MrzsCommandHandler(MrzsCommandHandler*, AnalogOutputInt32* command, uint16_t index, OperateType_uint8_t opType);
void DoOperate_AnalogOutputFloat32_in_MrzsCommandHandler(MrzsCommandHandler*, AnalogOutputFloat32* command, uint16_t index, OperateType_uint8_t opType);
void DoOperate_AnalogOutputDouble64_in_MrzsCommandHandler(MrzsCommandHandler*, AnalogOutputDouble64* command, uint16_t index, OperateType_uint8_t opType);
...
void SetResponse_in_MrzsCommandHandler(MrzsCommandHandler *pMrzsCommandHandler, CommandStatus status_);
