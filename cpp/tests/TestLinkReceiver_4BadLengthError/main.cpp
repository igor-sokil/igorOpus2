...
/*
std::string hex = "05 64 01 C0 01 00 00 04 E9 21";
std::string sss = RepairCRC_in_DNPHelpers(hex);
std::cout<<"sss= "<<sss;
*/
uint8_t sss[] = {0x05, 0x64, 0x01, 0xC0, 0x01, 0x00, 0x00, 0x04, 0x87, 0x6C};
...
// Изменяем длину с 5 на что-нибудь из [0,4] и пересчитываем crc
// Действительный пакет состояний канала сброса будет: 05 64 05 C0 01 00 00 04 E9 21
