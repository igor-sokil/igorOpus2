...
/*
std::string hex = "05 64 05 73 00 04 01 00 03 FC";
std::string sss = RepairCRC_in_DNPHelpers(hex);
std::cout<<"sss= "<<sss;
*/
///*
//sss= 05 64 05 73 00 04 01 00 66 41
uint8_t sss[] = {0x05, 0x64, 0x05, 0x73, 0x00, 0x04, 0x01, 0x00, 0x66, 0x41};
...
qDebug()<<"REQUIRE(t.parser.Statistics().numBadLength == 1)";
Parser_in_LinkStatistics* temp = Statistics_in_LinkLayerParser(&t.parser);

qDebug()<<"t.parser.Statistics().numBadLength= "<<temp->numBadLength;
//*/
/*
...
// Проверяем, что отсутствие пользовательских данных противоречит коду функции
// Это первые 10 байт неподтвержденного пакета пользовательских данных с длиной, равной 5
