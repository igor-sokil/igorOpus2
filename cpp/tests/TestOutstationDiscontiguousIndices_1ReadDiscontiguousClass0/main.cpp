...
////    t.SendToOutstation(request);
    uint8_t request[] = {5, 0xC0, 0x01, 0x3C, 0x01, 0x06};
    SendToOutstation_in_OutstationTestObject(&t, request);  

qDebug()<<"REQUIRE(QueryDiscontiguousBinary('C0 01 3C 01 06') == 'C0 81 80 00 01 02 00 02 02 81 01 02 00 04 05 01 02')";
