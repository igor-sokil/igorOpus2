********SUITE('10MixedClassLimitedCount')********
...
*        *PointClass_Class3= 8
    ...
    update_in_StaticDataMap_for_BinarySpecOver2_1
*    *iter->second.config.eEventConfig.clazz= 4
...
*        *PointClass_Class3= 8
    ...
    update_in_StaticDataMap_for_BinarySpecOver2_1
*    *iter->second.config.eEventConfig.clazz= 8
...
+            CheckForUnsolicited_in_OContext1
temp=     E0 81 8E 00 02 01 28 02 00 01 00 81 02 00 81
response= E0 81 8E 00 02 01 28 02 00 01 00 81 02 00 81
