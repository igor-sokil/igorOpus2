...
qDebug()<<"********SUITE('5AcceptsAssignClassViaStartStop')********";
...
//    std::string name("C0 16 3C 03 06 01 00 01 02 00 03 00");       
    uint8_t name[] = {12, 0xC0, 0x16, 0x3C, 0x03, 0x06, 0x01, 0x00, 0x01, 0x02, 0x00, 0x03, 0x00};
