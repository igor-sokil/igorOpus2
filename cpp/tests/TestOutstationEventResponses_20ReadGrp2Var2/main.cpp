...
void configure_in_20ReadGrp2Var2(DatabaseConfig*);
void configure_in_20ReadGrp2Var2(DatabaseConfig* db)
{
}

void update_in_20ReadGrp2Var2(IUpdateHandler*);
void update_in_20ReadGrp2Var2(IUpdateHandler* db)
{
    std::cout << "update_in_20ReadGrp2Var2" <<'\n';
////    auto update = [](IUpdateHandler& db) { db.Update(Binary(false, Flags(0x01), DNPTime(0x4571)), 3); };
 ...
 DNPTime dDNPTime;
 DNPTime_in_DNPTimeOver2(&dDNPTime, 0x4571);
