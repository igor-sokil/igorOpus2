...
qDebug()<<"********SUITE('20TestTwoPackets')********";
////    LinkParserTest t;
////    // back to back reset link
////// обратная ссылка для сброса
...
////    t.WriteData("05 64 05 C0 01 00 00 04 E9 21 05 64 05 C0 01 00 00 04 E9 21");
 std::string name1 = "05 64 05 C0 01 00 00 04 E9 21 05 64 05 C0 01 00 00 04 E9 21";
 WriteData_in_LinkParserTestOver3(&t, name1);

qDebug()<<"REQUIRE(t.sink.m_num_frames == 2)";
qDebug()<<"t.sink.m_num_frames= "<<t.sink.m_num_frames;

////    REQUIRE(t.sink.CheckLast(LinkFunction::PRI_RESET_LINK_STATES, true, 1, 1024));
boolean tmp = CheckLast_in_MockFrameSink(&(t.sink),
    LinkFunction_PRI_RESET_LINK_STATES, true, 1, 1024);
