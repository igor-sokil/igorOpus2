...
//    0);
    ...
    getDataMapKeys_for_AnalogSpec()[1] = 1;
    getDataMapKeys_for_AnalogSpec()[2] = 2;
    getDataMapKeys_for_AnalogSpec()[3] = 3;
    getDataMapKeys_for_AnalogSpec()[4] = 4;
    getDataMapKeys_for_AnalogSpec()[5] = 5;
    getDataMapKeys_for_AnalogSpec()[6] = 6;
    getDataMapKeys_for_AnalogSpec()[7] = 7;
    getDataMapKeys_for_AnalogSpec()[8] = 8;
    getDataMapKeys_for_AnalogSpec()[9] = 9;
    DatabaseConfig tmp = database_by_sizes_in_DatabaseHelpers(NUM_BINARY, NUM_ANALOG);
...
//    std::string name("C0 16 3C 03 06 01 00 01 02 00 03 00 3C 04 06 1E 00 06");       
    uint8_t name[] = {18, 0xC0, 0x16, 0x3C, 0x03, 0x06, 0x01, 0x00, 0x01, 0x02, 0x00, 0x03, 0x00, 0x3C, 0x04, 0x06, 0x1E, 0x00, 0x06};
