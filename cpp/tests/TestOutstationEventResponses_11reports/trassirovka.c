...
*                                                *qc= 40
                                                ...
                                                WriteTarget_in_Group22Var5_static1

                                                Write_in_Group22Var5_static1
*                                                *output->flags= 1
*                                                *output->value= 23
*                                                *(output->timeDNPTime).value= 767026808
...
+            CheckForUnsolicited_in_OContext1
temp=     E0 81 80 00 16 05 28 01 00 00 00 01 17 00 00 00 78 E6 B7 2D 60 01
response= E0 81 80 00 16 05 28 01 00 00 00 01 17 00 00 00 78 E6 B7 2D 60 01
