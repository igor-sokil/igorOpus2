...
/*
std::string hex = "05 64 05 C6 01 00 00 04 E9 21";
std::string sss = RepairCRC_in_DNPHelpers(hex);
std::cout<<"sss= "<<sss;
*/
///*
//sss= 05 64 05 C6 01 00 00 04 FD EB
uint8_t sss[] = {0x05, 0x64, 0x05, 0xC6, 0x01, 0x00, 0x00, 0x04, 0xFD, 0xEB};
...
qDebug()<<"REQUIRE(t.parser.Statistics().numBadFunctionCode == 1)";
Parser_in_LinkStatistics* temp = Statistics_in_LinkLayerParser(&t.parser);

qDebug()<<"t.parser.Statistics().numBadFunctionCode= "<<temp->numBadFunctionCode;
//*/
/*
// Test that the parser can handle an unknown PriToSec function code
// Reset Links w/ function code changed from 0 to 6
// Проверка того, что синтаксический анализатор может обработать неизвестный код функции PriToSec
// Сброс ссылок с изменением кода функции с 0 на 6
