********SUITE('8Class1OneByteLimitedCount')********
...
+            CheckForUnsolicited_in_OContext1
                ...
                IsIdle_in_StateIdle_override1
update_in_8Class1OneByteLimitedCount1
...
*                                                                        *DNPTime timeDNPTime.value= 1
*                                                                        *DNPTime timeDNPTime.quality= 0
@@@@                                                                        *write_to_in_UInt16_static = 6421371->2
...
+            CheckForUnsolicited_in_OContext1
request= C0 01 3C 02 07 01
response= E0 81 82 00 02 01 28 01 00 02 00 01
temp=     E0 81 82 00 02 01 28 01 00 02 00 01
