...
void configure_in_15ReadGrp32Var0(DatabaseConfig*);
void configure_in_15ReadGrp32Var0(DatabaseConfig* db)
{
}

void update_in_15ReadGrp32Var0(IUpdateHandler*);
void update_in_15ReadGrp32Var0(IUpdateHandler* db)
{
    std::cout << "update_in_15ReadGrp32Var0" <<'\n';
...
//    DatabaseConfig tmp = binary_input_in_DatabaseHelpers(1);
  ...
  configure_in_15ReadGrp32Var0(&database);
...
////    t.Transaction([&](IUpdateHandler& db) { loadFun(db); });
    Transaction_in_OutstationTestObject(&t, update_in_15ReadGrp32Var0);//void (*apply)(IUpdateHandler*));
...
qDebug()<<"REQUIRE('E0 81 80 00 20 01 28 01 00 00 00 01 00 00 00 00' == t.lower->PopWriteAsHex())";
