...
/*
std::string hex = "05 64 08 C0 01 00 00 04 E9 21";
std::string sss = RepairCRC_in_DNPHelpers(hex);
std::cout<<"sss= "<<sss;
*/

//sss= 05 64 08 C0 01 00 00 04 BC 43
uint8_t sss[] = {0x05, 0x64, 0x08, 0xC0, 0x01, 0x00, 0x00, 0x04, 0xBC, 0x43};
...
// Проверяем, что наличие пользовательских данных не соответствует коду функции
