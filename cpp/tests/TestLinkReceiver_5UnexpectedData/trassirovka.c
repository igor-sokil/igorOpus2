...
@@@@                    *read_from_in_UInt16_static = 6421896<-17340
...
*                        ***FORMAT_LOG_BLOCK(logger, flags::ERR, 'Unexpected LENGTH in frame: %i with FUNCTION: %s',***
*                        *LinkFunction_uint8_t func= 64
*                        *uint8_t user_data_length= 3
                        }ValidateHeaderParameters_in_LinkLayerParser4_
