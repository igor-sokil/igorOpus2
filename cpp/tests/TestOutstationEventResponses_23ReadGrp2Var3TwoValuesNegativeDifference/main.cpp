...
void configure_in_23ReadGrp2Var3TwoValuesNegativeDifference(DatabaseConfig*);
void configure_in_23ReadGrp2Var3TwoValuesNegativeDifference(DatabaseConfig* db)
{
}

void update_in_23ReadGrp2Var3TwoValuesNegativeDifference(IUpdateHandler*);
void update_in_23ReadGrp2Var3TwoValuesNegativeDifference(IUpdateHandler* db)
{
    std::cout << "update_in_23ReadGrp2Var3TwoValuesNegativeDifference" <<'\n';
...
qDebug()<<"********SUITE('23ReadGrp2Var3TwoValuesNegativeDifference')********";
...
////    TestEventRead("C0 01 02 03 06", rsp, update);
 ...
 std::string response("E0 81 80 00 33 01 07 01 71 45 00 00 00 00 02 03 28 01 00 03 00 01 00 00 33 01 07 01 70 45 00 00 00 00 02 03 28 01 00 04 00 81 00 00");       

 std::string request("C0 01 02 03 06");       
 TestEventRead(request, response,
                   ////const std::function<void(IUpdateHandler& db)>& loadFun,
                   update_in_23ReadGrp2Var3TwoValuesNegativeDifference,
                   ////const std::function<void(DatabaseConfig& db)>& configure = [](DatabaseConfig& view) {})
                   configure_in_23ReadGrp2Var3TwoValuesNegativeDifference);
