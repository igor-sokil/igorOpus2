********SUITE('2ReceiveNewRequestSolConfirmWait')********
...
apply_in_2ReceiveNewRequestSolConfirmWait1
...
*    *sizeof(BufferSer4)=2048
*    *uint8_t bytes[SIZE_BufferSer4]=6402432
...
*            *id.variation= 2
*            *qc= 6
@@@@            *write_in_UInt8_static = 6402434->60
@@@@            *write_in_UInt8_static = 6402435->2
@@@@            *write_in_UInt8_static = 6402436->6
...
*        @*buffer->buffer_[i]= 6402495<-1
*        @*buffer->buffer_[i]= 6402496<-3c
*        @*buffer->buffer_[i]= 6402497<-2
*        @*buffer->buffer_[i]= 6402498<-6
...
*                                                *pList_for_EventRecord->head= 6405840

                                                    From__in__Iterator_in_List_for_EventRecord_static1
*                                                    *Node_for_EventRecord* start= 6405840
...
*                                                    @*buffer->buffer_[i]= 6402497<-2
*                                                    @*buffer->buffer_[i]= 6402498<-6
@@@@                                                    *read_in_UInt8_static = 6402496<-60
@@@@                                                    *read_in_UInt8_static = 6402497<-2
@@@@                                                    *read_in_UInt8_static = 6402498<-6
...
*cancel_in_MockTimer_override=1762693648
}MockTimer_in_MockTimer_
*tTimerExe4cpp.iITimer.psource_in_ITimer=6405064
...
temp= E0 81 80 00 02 01 28 01 00 00 00 81
...
@@@@                        *FunctionCode_READ
                            ...
                            {OnNewReadRequest_in_StateSolicitedConfirmWait_override1

                                {cancel_in_TimerExe4cpp1
                                *TimerExe4cpp *pTimerExe4cpp= 6415796
                                *pTimerExe4cpp->timerExe4cpp.psource_in_ITimer= 6405064

                                    {cancel_in_ITimer1
                                    *pITimer->psource_in_ITimer= 6405064
...
*tTimerExe4cpp.iITimer.psource_in_ITimer=6405064
                            ...
                            }OnNewReadRequest_in_StateSolicitedConfirmWait_override_
                        }ProcessNewRequest_in_OContext1_
...
temp2= E1 81 80 00 02 01 28 01 00 00 00 81
