...
////            db.Update(Binary(true, Flags(0x01)), 0); 
         Update_Binary_in_IUpdateHandler(db, &bBinary, DATAMAPKEYS1, EventMode_Detect);// = EventMode::Detect) = 0;
}
...
///    REQUIRE(t.lower->PopWriteAsHex() == "E1 81 80 00 02 01 28 01 00 00 00 81");
    uint8_t name2[] = {5, 0xC1, 0x01, 0x3C, 0x02, 0x06};
