 ...
 */
#ifndef OPENDNP3_STATICDATAMAP_BinaryOutputStatus_H
#define OPENDNP3_STATICDATAMAP_BinaryOutputStatus_H
...
////  using map_t_StaticDataMap_for_BinaryOutputStatusSpec = std::map<uint16_t, StaticDataCell_for_BinaryOutputStatus>;
////  using map_iter_t_StaticDataMap_for_BinaryOutputStatusSpec = typename map_t_StaticDataMap_for_BinaryOutputStatusSpec::iterator;

////template<class Spec> class StaticDataMap : private Uncopyable
////class StaticDataMap_for_BinaryOutputStatusSpec
typedef struct
{
//public:
...
/*
  class iterator
  {
    ...
    map_iter_t_StaticDataMap_for_BinaryOutputStatusSpec end;
    Range& range;

  public:
    explicit iterator(map_iter_t_StaticDataMap_for_BinaryOutputStatusSpec begin,
                      map_iter_t_StaticDataMap_for_BinaryOutputStatusSpec end, Range& range) : iter(begin), end(end), range(range) {}

////        using value_type = std::pair<uint16_t, SelectedValue<Spec>>;
    using value_type = std::pair<uint16_t, SelectedValue_for_BinaryOutputStatusSpec>;
    using difference_type = typename map_iter_t_StaticDataMap_for_BinaryOutputStatusSpec::difference_type;
    using pointer = typename map_iter_t_StaticDataMap_for_BinaryOutputStatusSpec::pointer;
////        using reference = std::pair<uint16_t, SelectedValue<Spec>&>;
    using reference = std::pair<uint16_t, SelectedValue_for_BinaryOutputStatusSpec&>;
...
*/
////private:
////  map_t_StaticDataMap_for_BinaryOutputStatusSpec map;
  StaticDataCell_for_BinaryOutputStatus map[SIZE_StaticDataMap_for_BinaryOutputStatusSpec];
  Range selected;
  DatabaseConfig *db_config;
  Range iterator_for_BinayOutputStatusSpec;
...
} StaticDataMap_for_BinaryOutputStatusSpec;
...
uint16_t select_all_in_StaticDataMap_for_BinaryOutputStatusSpecOver2(StaticDataMap_for_BinaryOutputStatusSpec *pStaticDataMap_for_BinaryOutputStatusSpec, StaticBinaryVariation_uint8_t variation);
...
template<class F> uint16_t select_all_in_StaticDataMap_for_BinaryOutputStatusSpecOver3(StaticDataMap_for_BinaryOutputStatusSpec *pStaticDataMap_for_BinaryOutputStatusSpec, F get_variation)
{
//qDebug()<<"";
//qDebug()<<"select_all_in_StaticDataMap_for_BinaryOutputStatusSpecOver3_1";
...
////        this->selected = Range::From(map.begin()->first, map.rbegin()->first);
    ...
    {
//qDebug()<<"iter___";
// StaticBinaryOutputStatusVariation_uint8_t check_for_promotion_for_BinaryOutputStatusSpec(BinaryOutputStatus* value, StaticBinaryOutputStatusVariation_uint8_t variation);
...
////                check_for_promotion<Spec>(iter.second.value, get_variation(iter.second.config.svariation))};
      ...
      SelectedValue_for_BinaryOutputStatusSpec_in_SelectedValue_for_BinaryOutputStatusSpecOver2(&sSelectedValue_for_BinaryOutputStatusSpec,
          ...
          check_for_promotion_for_BinaryOutputStatusSpec_static(&iter.second.value_in_StaticDataCell, get_variation(iter.second.config_in_StaticDataCell.eEventConfig.svariation)));

      iter.second.selection_in_StaticDataCell = sSelectedValue_for_BinaryOutputStatusSpec;
    }//for

//qDebug()<<"map.size= "<<pStaticDataMap_for_BinaryOutputStatusSpec->map.size();
...
////            true, iter->second.value,
////            check_for_promotion<Spec>(iter->second.value, get_variation(iter->second.config.svariation))};
    BinaryOutputStatus bBinaryOutputStatus = iter->second.value_in_StaticDataCell;
    SelectedValue_for_BinaryOutputStatusSpec sSelectedValue_for_BinaryOutputStatusSpec = {
      true, bBinaryOutputStatus, check_for_promotion_for_BinaryOutputStatusSpec_static(&bBinaryOutputStatus, get_variation(iter->second.config_in_StaticDataCell.eEventConfig.svariation))
    };
    iter->second.selection_in_StaticDataCell = sSelectedValue_for_BinaryOutputStatusSpec;
    ++count;
  }
