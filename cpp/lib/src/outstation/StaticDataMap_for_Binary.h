...
////private:
 // map_t_StaticDataMap_for_BinarySpec map;
  StaticDataCell_for_Binary map[SIZE_StaticDataMap_for_BinarySpec];
  Range selected_in_StaticDataMap_for_BinarySpec;
...
#ifdef  LOG_INFO
  std::cout<<"*"<<getString_stack_info();
  std::cout<<"*start->first= "<<(uint16_t)start->first<<'\n';
  std::cout<<"*"<<getString_stack_info();
  std::cout<<"*stop= "<<(uint16_t)stop<<'\n';
//  decrement_stack_info();
#endif
...
#ifdef  LOG_INFO
  std::cout<<"*"<<getString_stack_info();
  std::cout<<"*rRange.start= "<<(uint16_t)rRange.start<<'\n';
  std::cout<<"*"<<getString_stack_info();
  std::cout<<"*rRange.stop= "<<(uint16_t)rRange.stop<<'\n';
