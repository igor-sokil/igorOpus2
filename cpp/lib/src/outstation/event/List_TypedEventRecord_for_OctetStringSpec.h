 ...
 */
#ifndef OPENDNP3_List_TypedEventRecord_for_OctetStringSpec_H
#define OPENDNP3_List_TypedEventRecord_for_OctetStringSpec_H
...
////
////        Node<T>* current;
  Node_TypedEventRecord_for_OctetStringSpec * current;
} Iterator_in_List_TypedEventRecord_for_OctetStringSpec;
...
////    Node<T>* free = nullptr;
  ...
  Node_TypedEventRecord_for_OctetStringSpec* head;// = nullptr;
  Node_TypedEventRecord_for_OctetStringSpec* tail;// = nullptr;
  Node_TypedEventRecord_for_OctetStringSpec* free;// = nullptr;

////    ser4cpp::Array<Node<T>, list_size_type_t> underlying;
  Array__for__Node_TypedEventRecord_for_OctetStringSpec  underlying;
...
////    void Initialize();
} List_TypedEventRecord_for_OctetStringSpec;
