 ...
 */
#ifndef OPENDNP3_EVENTWRITERS_for_DoubleBitBinary_H
#define OPENDNP3_EVENTWRITERS_for_DoubleBitBinary_H
...
typedef struct
{
  IEventWriter_for_DoubleBitBinary iIEventWriter_for_DoubleBitBinary;
  PrefixedWriteIterator_for_UInt16_DoubleBitBinary iterator;

} BasicEventWriter_for_DoubleBitBinary;
...
////            return this->iterator.Write(copy, index);
////        }
} CTOEventWriter_for_DoubleBitBinary_Group51Var1;
...
////            return this->iterator.Write(copy, index);
////        }
} CTOEventWriter_for_DoubleBitBinary_Group51Var2;
