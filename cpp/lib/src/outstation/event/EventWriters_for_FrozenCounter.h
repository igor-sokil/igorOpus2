 ...
 */
#ifndef OPENDNP3_EVENTWRITERS_for_FrozenCounter_H
...
typedef struct
{
  IEventWriter_for_FrozenCounter iIEventWriter_for_FrozenCounter;
  PrefixedWriteIterator_for_UInt16_FrozenCounter iterator;

} BasicEventWriter_for_FrozenCounter;
...
////            return this->iterator.Write(copy, index);
////        }
} CTOEventWriter_for_FrozenCounter_Group51Var1;
...
////            return this->iterator.Write(copy, index);
////        }
} CTOEventWriter_for_FrozenCounter_Group51Var2;
