 ...
 */
#ifndef OPENDNP3_EVENTWRITERS_for_BinaryOutputStatus_H
#define OPENDNP3_EVENTWRITERS_for_BinaryOutputStatus_H
...
typedef struct
{
  IEventWriter_for_BinaryOutputStatus iIEventWriter_for_BinaryOutputStatus;
  PrefixedWriteIterator_for_UInt16_BinaryOutputStatus iterator;

} BasicEventWriter_for_BinaryOutputStatus;
...
////            return this->iterator.Write(copy, index);
////        }
} CTOEventWriter_for_BinaryOutputStatus_Group51Var1;
...
////            return this->iterator.Write(copy, index);
////        }
} CTOEventWriter_for_BinaryOutputStatus_Group51Var2;
