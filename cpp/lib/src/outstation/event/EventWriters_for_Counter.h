 ...
 */
#ifndef OPENDNP3_EVENTWRITERS_for_Counter_H
#define OPENDNP3_EVENTWRITERS_for_Counter_H
...
typedef struct
{
  IEventWriter_for_Counter iIEventWriter_for_Counter;
  PrefixedWriteIterator_for_UInt16_Counter iterator;

} BasicEventWriter_for_Counter;
...
////            return this->iterator.Write(copy, index);
////        }
} CTOEventWriter_for_Counter_Group51Var1;
...
////            return this->iterator.Write(copy, index);
////        }
} CTOEventWriter_for_Counter_Group51Var2;
