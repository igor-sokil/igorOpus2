 ...
 */
#ifndef OPENDNP3_EVENTWRITERS_for_Analog_H
#define OPENDNP3_EVENTWRITERS_for_Analog_H
...
typedef struct
{
  ...
  PrefixedWriteIterator_for_UInt16_Analog iterator;

} BasicEventWriter_for_Analog;
...
////            return this->iterator.Write(copy, index);
////        }
} CTOEventWriter_for_Analog_Group51Var1;
...
////            return this->iterator.Write(copy, index);
////        }
} CTOEventWriter_for_Analog_Group51Var2;
