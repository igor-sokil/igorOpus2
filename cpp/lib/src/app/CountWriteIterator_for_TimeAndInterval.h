 ...
 */
#ifndef OPENDNP3_COUNTWRITEITERATOR_for_TimeAndInterval_H
#define OPENDNP3_COUNTWRITEITERATOR_for_TimeAndInterval_H
...
} CountWriteIterator_for_UInt8_TimeAndInterval;
...
////    Serializer<WriteType> serializer;
  ...
  WSeq_for_Uint16_t countPosition; // make a copy to record where we write the count
  WSeq_for_Uint16_t* pPosition;
} CountWriteIterator_for_UInt16_TimeAndInterval;
