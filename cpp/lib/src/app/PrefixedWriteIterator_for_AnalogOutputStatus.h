 ...
 */
#ifndef OPENDNP3_PREFIXEDWRITEITERATOR_for_AnalogOutputStatus_H
#define OPENDNP3_PREFIXEDWRITEITERATOR_for_AnalogOutputStatus_H
...
} PrefixedWriteIterator_for_UInt8_AnalogOutputStatus;
