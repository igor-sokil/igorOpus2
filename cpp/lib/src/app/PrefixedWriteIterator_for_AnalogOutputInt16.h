 ...
 */
#ifndef OPENDNP3_PREFIXEDWRITEITERATOR_for_AnalogOutputInt16_H
#define OPENDNP3_PREFIXEDWRITEITERATOR_for_AnalogOutputInt16_H
...
////private:
  ...
  Serializer_for_AnalogOutputInt16 serializer;
...
} PrefixedWriteIterator_for_UInt8_AnalogOutputInt16;
...
////    typename PrefixType::type_t count;
  ...
  WSeq_for_Uint16_t countPosition; // make a copy to record where we write the count
  WSeq_for_Uint16_t* pPosition;
} PrefixedWriteIterator_for_UInt16_AnalogOutputInt16;
