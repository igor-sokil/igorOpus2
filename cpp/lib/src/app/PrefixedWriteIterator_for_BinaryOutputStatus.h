 ...
 */
#ifndef OPENDNP3_PREFIXEDWRITEITERATOR_for_BinaryOutputStatus_H
#define OPENDNP3_PREFIXEDWRITEITERATOR_for_BinaryOutputStatus_H
...
} PrefixedWriteIterator_for_UInt8_BinaryOutputStatus;
