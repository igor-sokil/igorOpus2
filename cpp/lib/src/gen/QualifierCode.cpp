...
QualifierCode_uint8_t from_type_in_QualifierCodeSpec_static(uint8_t arg)
{
  ...
  {
    case(0x0):
      return QualifierCode_UINT8_START_STOP;
    case(0x1):
      return QualifierCode_UINT16_START_STOP;
    case(0x6):
      return QualifierCode_ALL_OBJECTS;
    case(0x7):
      return QualifierCode_UINT8_CNT;
    case(0x8):
      return QualifierCode_UINT16_CNT;
    case(0x17):
      return QualifierCode_UINT8_CNT_UINT8_INDEX;
    case(0x28):
      return QualifierCode_UINT16_CNT_UINT16_INDEX;
    default:
      return QualifierCode_UNDEFINED;
  }
}
/*
