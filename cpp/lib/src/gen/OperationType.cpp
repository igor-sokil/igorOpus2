...
OperationType_uint8_t from_type_in_OperationTypeSpec_static(uint8_t arg)
{
  ...
  {
    case(0x0):
      return OperationType_NUL;
    case(0x1):
      return OperationType_PULSE_ON;
    case(0x2):
      return OperationType_PULSE_OFF;
    case(0x3):
      return OperationType_LATCH_ON;
    case(0x4):
      return OperationType_LATCH_OFF;
    default:
      return OperationType_Undefined;
  }
}
/*
