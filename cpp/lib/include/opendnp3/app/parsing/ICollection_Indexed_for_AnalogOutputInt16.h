...
{
////public:
  void (*pOnValue_in_IVisitor_Indexed_for_AnalogOutputInt16)(void*, Indexed_for_AnalogOutputInt16 value);// = 0;

  void* pParentPointer_in_IVisitor_Indexed_for_AnalogOutputInt16;
} IVisitor_Indexed_for_AnalogOutputInt16;

void* getParentPointer_in_IVisitor_Indexed_for_AnalogOutputInt16(IVisitor_Indexed_for_AnalogOutputInt16*);
void  setParentPointer_in_IVisitor_Indexed_for_AnalogOutputInt16(IVisitor_Indexed_for_AnalogOutputInt16*, void*);

void OnValue_in_IVisitor_Indexed_for_AnalogOutputInt16(IVisitor_Indexed_for_AnalogOutputInt16 *, Indexed_for_AnalogOutputInt16 );
...
{
////public:
  IVisitor_Indexed_for_AnalogOutputInt16 iIVisitor_Indexed_for_AnalogOutputInt16;

////private:
  void (*Fun)(Indexed_for_AnalogOutputInt16 item);

} FunctorVisitor_Indexed_for_AnalogOutputInt16;
...
////    virtual void Foreach(IVisitor<T>& visitor) const = 0;
    void (*pForeach_in_ICollection_Indexed_for_AnalogOutputInt16)(void *, IVisitor_Indexed_for_AnalogOutputInt16 *pIVisitor_Indexed_for_AnalogOutputInt16);// const = 0;
