...
{
////public:
  void (*pOnValue_in_IVisitor_Indexed_for_OctetString)(void*, Indexed_for_OctetString value);// = 0;

  void* pParentPointer_in_IVisitor_Indexed_for_OctetString;
} IVisitor_Indexed_for_OctetString;

void* getParentPointer_in_IVisitor_Indexed_for_OctetString(IVisitor_Indexed_for_OctetString*);
void  setParentPointer_in_IVisitor_Indexed_for_OctetString(IVisitor_Indexed_for_OctetString*, void*);

void OnValue_in_IVisitor_Indexed_for_OctetString(IVisitor_Indexed_for_OctetString *, Indexed_for_OctetString );
...
{
////public:
  IVisitor_Indexed_for_OctetString iIVisitor_Indexed_for_OctetString;

////private:
  void (*Fun)(Indexed_for_OctetString item);

} FunctorVisitor_Indexed_for_OctetString;
...
////    virtual void Foreach(IVisitor<T>& visitor) const = 0;
    void (*pForeach_in_ICollection_Indexed_for_OctetString)(void *, IVisitor_Indexed_for_OctetString *pIVisitor_Indexed_for_OctetString);// const = 0;
