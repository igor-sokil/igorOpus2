...
#define LinkFunction_uint8_t uint8_t
enum LinkFunction 
{
  LinkFunction_PRI_RESET_LINK_STATES = 0x40,
  LinkFunction_PRI_TEST_LINK_STATES = 0x42,
  LinkFunction_PRI_CONFIRMED_USER_DATA = 0x43,
  LinkFunction_PRI_UNCONFIRMED_USER_DATA = 0x44,
  LinkFunction_PRI_REQUEST_LINK_STATUS = 0x49,
  LinkFunction_SEC_ACK = 0x0,
  LinkFunction_SEC_NACK = 0x1,
  LinkFunction_SEC_LINK_STATUS = 0xB,
  LinkFunction_SEC_NOT_SUPPORTED = 0xF,
