...
enum AssignClassType 
{
  AssignClassType_BinaryInput = 0x0,
  AssignClassType_DoubleBinaryInput = 0x1,
  AssignClassType_Counter = 0x2,
  AssignClassType_FrozenCounter = 0x3,
  AssignClassType_AnalogInput = 0x4,
  AssignClassType_BinaryOutputStatus = 0x5,
  AssignClassType_AnalogOutputStatus = 0x6
};
