...
#define EventSecurityStatVariation_uint8_t uint8_t
enum EventSecurityStatVariation 
{
  EventSecurityStatVariation_Group122Var1 = 0,
  EventSecurityStatVariation_Group122Var2 = 1
};
