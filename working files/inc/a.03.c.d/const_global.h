...
#define MASKA_BUTTON_MODE_1_SIGNALS_0 (                        \
  ...
  | (1u << (RANG_SMALL_BLOCK_DZ1 - 0))                         \
  | (1u << (RANG_SMALL_BLOCK_DZ2 - 0))                         \
  | (1u << (RANG_SMALL_BLOCK_PR_DZ2 - 0))                      \
  | (1u << (RANG_SMALL_OP_PR_DZ2 - 0))                         \
  | (1u << (RANG_SMALL_BLOCK_DZ3 - 0))                         \
  | (1u << (RANG_SMALL_BLOCK_PR_DZ3 - 0))                      \
  | (1u << (RANG_SMALL_OP_PR_DZ3 - 0))                         \
  | (1u << (RANG_SMALL_BLOCK_DZ4 - 0))                         \
  | (1u << (RANG_SMALL_BLOCK_PR_DZ4 - 0))                      \
  | (1u << (RANG_SMALL_OP_PR_DZ4 - 0))                         \
  | (1u << (RANG_SMALL_BLOCK_MTZ1 - 0))                        \
  | (1u << (RANG_SMALL_BLOCK_MTZ2 - 0))                        \
  | (1u << (RANG_SMALL_BLOCK_USK_MTZ2 - 0))                    \
  | (1u << (RANG_SMALL_BLOCK_MTZ3 - 0))                        \
  | (1u << (RANG_SMALL_BLOCK_MTZ4 - 0))                        \
  | (1u << (RANG_SMALL_BLOCK_ZNAM - 0))                        \
)
...
#define MASKA_FOR_INPUT_SIGNALS_1        (                       \
  ...
  | (1u << (RANG_BLOCK_DZ2 - 32))                                \
  | (1u << (RANG_BLOCK_PR_DZ2 - 32))                             \
  | (1u << (RANG_OP_PR_DZ2 - 32))                                \
  | (1u << (RANG_BLOCK_DZ3 - 32))                                \
  | (1u << (RANG_BLOCK_PR_DZ3 - 32))                             \
  | (1u << (RANG_OP_PR_DZ3 - 32))                                \
  | (1u << (RANG_BLOCK_DZ4 - 32))                                \
  | (1u << (RANG_BLOCK_PR_DZ4 - 32))                             \
)

#define MASKA_FOR_INPUT_SIGNALS_2        (                     \
    (1u << (RANG_OP_PR_DZ4 - 64))                              \
  | (1u << (RANG_EXT_NKN_DZ - 64))                             \
  | (1u << (RANG_BLOCK_MTZ1 - 64))                             \
  | (1u << (RANG_BLOCK_MTZ2 - 64))                             \
  | (1u << (RANG_BLOCK_USK_MTZ2 - 64))                         \
  | (1u << (RANG_BLOCK_MTZ3 - 64))                             \
...
#define MASKA_FOR_INPUT_SIGNALS_4        (                     \
  ...
  | (1u << (RANG_BLOCK_TZNP1 - 128))                           \
  | (1u << (RANG_BLOCK_TZNP2 - 128))                           \
  | (1u << (RANG_BLOCK_TZNP3 - 128))                           \
)
    
#define MASKA_FOR_INPUT_SIGNALS_5        (                     \
    (1u << (RANG_STAT_BLK_APV - 160))                          \
  | (1u << (RANG_ACHR_CHAPV_VID_DV - 160))                     \
  | (1u << (RANG_BLOCK_ACHR1 - 160))                           \
...
#define MASKA_FOR_INPUT_SIGNALS_8        (                     \
  ...
  | (1u << (RANG_DT3_SET - 256))                               \
  | (1u << (RANG_DT3_RESET - 256))                             \
  | (1u << (RANG_DT4_SET - 256))                               \
  | (1u << (RANG_DT4_RESET - 256))                             \
)
...
#define MASKA_DZ_SIGNALS_1        (                           \
   ...
   | (1u << (RANG_PO_DZ1 - 32))                               \
   | (1u << (RANG_DZ1 - 32))                                  \
   | (1u << (RANG_PO_AMTZ_DZ1 - 32))                          \
   | (1u << (RANG_AMTZ_DZ1 - 32))                             \
   | (1u << (RANG_BLOCK_DZ2 - 32))                            \
   | (1u << (RANG_BLOCK_PR_DZ2 - 32))                         \
   | (1u << (RANG_OP_PR_DZ2 - 32))                            \
   | (1u << (RANG_SECTOR_DIR_DZ2 - 32))                       \
   | (1u << (RANG_SECTOR_INV_DZ2 - 32))                       \
   | (1u << (RANG_PO_DIR_DZ2 - 32))                           \
   | (1u << (RANG_PO_INV_DZ2 - 32))                           \
   | (1u << (RANG_DZ2 - 32))                                  \
   | (1u << (RANG_PO_AMTZ_DZ2 - 32))                          \
   | (1u << (RANG_AMTZ_DZ2 - 32))                             \
   | (1u << (RANG_BLOCK_DZ3 - 32))                            \
   | (1u << (RANG_BLOCK_PR_DZ3 - 32))                         \
   | (1u << (RANG_OP_PR_DZ3 - 32))                            \
   | (1u << (RANG_SECTOR_DIR_DZ3 - 32))                       \
   | (1u << (RANG_SECTOR_INV_DZ3 - 32))                       \
   | (1u << (RANG_PO_DIR_DZ3 - 32))                           \
   | (1u << (RANG_PO_INV_DZ3 - 32))                           \
   | (1u << (RANG_DZ3 - 32))                                  \
   | (1u << (RANG_PO_AMTZ_DZ3 - 32))                          \
   | (1u << (RANG_AMTZ_DZ3 - 32))                             \
   | (1u << (RANG_BLOCK_DZ4 - 32))                            \
   | (1u << (RANG_BLOCK_PR_DZ4 - 32))                         \
)
...
#define MASKA_DZ_SIGNALS_2        (                           \
   ...
   | (1u << (RANG_DZ4 - 64))                                  \
   | (1u << (RANG_PO_AMTZ_DZ4 - 64))                          \
   | (1u << (RANG_AMTZ_DZ4 - 64))                             \
   | (1u << (RANG_EXT_NKN_DZ - 64))                           \
   | (1u << (RANG_NKN_DZ - 64))                               \
   | (1u << (RANG_PO_U_DZ - 64))                              \
   | (1u << (RANG_PO_I_BLK_DZ - 64))                          \
   | (1u << (RANG_3F_DZ_DIR_INV - 64))                        \
   | (1u << (RANG_SNKN_DZ - 64))                              \
)
...
#define MASKA_MTZ_SIGNALS_3        (                           \
   ...
   | (1u << (RANG_PO_MTZ3 - 96))                               \
   | (1u << (RANG_PO_MTZN3_VPERED - 96))                       \
   | (1u << (RANG_PO_MTZN3_NAZAD - 96))                        \
   | (1u << (RANG_PO_U_MTZPN3 - 96))                           \
   | (1u << (RANG_PO_MTZPN3 - 96))                             \
   | (1u << (RANG_MTZ3 - 96))                                  \
   | (1u << (RANG_SECTOR_VPERED_MTZN4 - 96))                   \
   | (1u << (RANG_SECTOR_NAZAD_MTZN4 - 96))                    \
   | (1u << (RANG_PO_MTZ4 - 96))                               \
   | (1u << (RANG_PO_MTZN4_VPERED - 96))                       \
   | (1u << (RANG_PO_MTZN4_NAZAD - 96))                        \
   | (1u << (RANG_PO_U_MTZPN4 - 96))                           \
   | (1u << (RANG_PO_MTZPN4 - 96))                             \
   | (1u << (RANG_MTZ4 - 96))                                  \
...
#define MASKA_ZDZ_SIGNALS_3        (                           \
   ...
   | (1u << (RANG_LIGHT_ZDZ_FROM_OVD1 - 96))                   \
   | (1u << (RANG_LIGHT_ZDZ_FROM_OVD2 - 96))                   \
   | (1u << (RANG_LIGHT_ZDZ_FROM_OVD3 - 96))                   \
   | (1u << (RANG_PO_ZDZ - 96))                                \
   | (1u << (RANG_ZDZ - 96))                                   \
)
...
#define MASKA_TZNP_SIGNALS_4       (                           \
     (1u << (RANG_BLOCK_TZNP1 - 128))                          \
   | (1u << (RANG_SECTOR_TZNP1_VPERED - 128))                  \
   | (1u << (RANG_SECTOR_TZNP1_NAZAD - 128))                   \
   | (1u << (RANG_PO_3I0_TZNP1_VPERED - 128))                  \
   | (1u << (RANG_PO_3I0_TZNP1_NAZAD - 128))                   \
   | (1u << (RANG_PO_3U0_TZNP1_VPERED - 128))                  \
...
#define MASKA_APV_SIGNALS_5        (                           \
     (1u << (RANG_STAT_BLK_APV - 160))                         \
   | (1u << (RANG_APV1 - 160))                                 \
   | (1u << (RANG_APV2 - 160))                                 \
   | (1u << (RANG_APV3 - 160))                                 \
   | (1u << (RANG_APV4 - 160))                                 \
   | (1u << (RANG_APV_WORK - 160))                             \
)
...
#define MASKA_UMIN_SIGNALS_6       (                           \
   ...
   | (1u << (RANG_UMIN1 - 192))                                \
   | (1u << (RANG_PO_UMIN2 - 192))                             \
   | (1u << (RANG_PO_UBLK_UMIN2 - 192))                        \
   | (1u << (RANG_PO_IBLK_UMIN2 - 192))                        \
   | (1u << (RANG_UMIN2 - 192))                                \
)
...
#define MASKA_MONITOTYNG_Z_SIGNALES_1 (                       \
     (1u << (RANG_PO_DZ1 - 32))                               \
   | (1u << (RANG_DZ1 - 32))                                  \
   | (1u << (RANG_PO_DIR_DZ2 - 32))                           \
   | (1u << (RANG_PO_INV_DZ2 - 32))                           \
...
#define MASKA_MONITOTYNG_PHASE_SIGNALES_1 (                    \
     (1u << (RANG_PO_AMTZ_DZ1 - 32))                           \
   | (1u << (RANG_AMTZ_DZ1 - 32))                              \
   | (1u << (RANG_PO_AMTZ_DZ2 - 32))                           \
   | (1u << (RANG_AMTZ_DZ2 - 32))                              \
